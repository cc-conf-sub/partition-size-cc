...
public class RunKLocalSearch {


    public static void main(String args[]) {

        String data_set = args[0];
	int init_k = Integer.parseInt(args[1]);
        String delimiter = "\\s"; 
        ...
        int[] k_vals = {14000}; // {10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 110000, 120000, 130000, 140000, 150000};
	...
	long hybridScoreTotal = 0;
        ...
        ArrayList<ArrayList<Integer>> pivot_result = KLocalSearch.fast_k_local_search(prob_matrix, k, 0.0);
        ...
        ArrayList<ArrayList<Integer>> fill_result =  KLocalSearch.fast_k_local_search(prob_matrix, k, -1);
        ...
        ArrayList<ArrayList<Integer>> rand_result = pivot_result;// KLocalSearch.k_local_search_network2(prob_matrix, k, 5.0);
        ...
        ArrayList<ArrayList<Integer>> blend_result = pivot_result; // KLocalSearch.k_local_search_network2(prob_matrix, k, 10.0);
        ...
        ArrayList<ArrayList<Integer>> fix = pivot_result; // KLocalSearch.k_local_search_network2(prob_matrix, k, -1);
