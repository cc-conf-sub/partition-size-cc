...
public class RunKBlend {
	...
	long hybridScoreTotal = 0;
        ...
        ArrayList<ArrayList<Integer>> pivot_result = DNode.fast_k_vote(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> fill_result = pivot_result; // KLocalSearch.k_local_search_network2(prob_matrix, k, 1.0);
